...
namespace uSensorAktorInterface
{
    ...
    public class KnobControl : System.Windows.Forms.UserControl
    {
        ...
        private Rectangle rName;
        private Rectangle rValue;
        private Font fontValue;
        private Font fontName;
        private Brush bInfo;
        private StringFormat sfInfo;
        ...
        public int Maximum
        {
            get { return _Maximum; }
            set { _Maximum = value;
                LargeChange = (int)((double)value * 0.05);
            }
        }
        ...
        public KnobControl(usai u)
        {
            ...
            fontName = new Font("Arial", 10);
            bInfo = new SolidBrush(Color.Black);
            sfInfo = new StringFormat();
            sfInfo.Alignment = StringAlignment.Center;
            InitializeComponent();
            setDimensions();
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            gOffScreen.DrawString(myU.Name, fontName, bInfo, rName, sfInfo);
            gOffScreen.DrawString(myU.Value.ToString(), fontValue, bInfo, rValue, sfInfo);
        ...
        private void setDimensions()
        {
            ...
            this.rName = new Rectangle((int)(size * 0.10), (int)(size * 0.60), (int)(size * 0.80), (int)(size * 0.20));
            this.rValue = new Rectangle((int)(size * 0.10), (int)(size * 0.40), (int)(size * 0.80), (int)(size * 0.20));
